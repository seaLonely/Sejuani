...
import { RootConfig, SejuaniConfig } from './schema';
import { CONFIG_FILENAME, DEFAULT_CONFIG, DEFAULT_DOMAIN } from './defaults';
import { getActiveDomainOverride } from '../state/domain';
import { getRegistryOverride } from '../state/registryOverrides';

/** 一次扫描的目标目录与深度（resolveScanTarget / 交互选择的产物） */
 ...
 */
export function resolveScanTarget(cfg: RootConfig): ScanTarget {
